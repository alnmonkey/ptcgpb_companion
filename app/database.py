...
#
#             db_path = BASE_DIR / "data" / "cardcounter.db"
#
...
#                     """
#                     UPDATE screenshots
#                     SET pack_type       = CASE WHEN pack_type = 'Unknown' OR pack_type = '' THEN ? ELSE pack_type END,
#                         card_types      = CASE WHEN card_types = '' THEN ? ELSE card_types END,
#                         card_counts     = CASE
#                                               WHEN card_counts = '0' OR card_counts = '' OR card_counts IS NULL THEN ?
#                                               ELSE card_counts END,
#                         account         = CASE
#                                               WHEN account = 'Account Unknown' OR account = 'Default' OR account = '' OR
#                                                    account LIKE '%.png' OR account LIKE '%.jpg' THEN ?
#                                               ELSE account END,
#                         clean_filename  = CASE
#                                               WHEN clean_filename = 'Account Unknown' OR clean_filename = 'Default' OR
#                                                    clean_filename = '' OR clean_filename LIKE '%.png' OR
#                                                    clean_filename LIKE '%.jpg' THEN ?
#                                               ELSE clean_filename END,
#                         screenshot_path = CASE
#                                               WHEN screenshot_path IS NULL OR screenshot_path = '' THEN ?
#                                               ELSE screenshot_path END,
...
#             cursor.execute(
#                 """
#                 INSERT INTO screenshots (timestamp, original_filename, clean_filename, account,
...
#                 """
#                 INSERT
#                 OR IGNORE INTO cards (card_name, card_set, card_code, image_path, rarity)
#                 VALUES (?, ?, ?, ?, ?)
#                 """,
...
#                 """
#                 INSERT
#                 OR IGNORE INTO screenshot_cards (screenshot_id, card_id, position, confidence)
#                 VALUES (?, ?, ?, ?)
#                 """,
...
#             query = """
#                     DELETE
#                     FROM screenshot_cards
#                     WHERE id = (SELECT sc.id
